...
TEST_CASE( "StreamInsertion" ) {
    ...
    //don't care about order, just that values are there
    REQUIRE( s1.find('1') != string::npos );
    REQUIRE( s1.find('2') != string::npos );
    REQUIRE( s1.find('3') != string::npos );
    REQUIRE( s1.find('4') == string::npos );
